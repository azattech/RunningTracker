...
object ServiceModule {
    ...
    fun provideMainActivityPendingIntent(
        ...
        PendingIntent.FLAG_UPDATE_CURRENT // whenever we launch that PendingIntent and it already exists it will update it instead of recreating or restarting it
    )
